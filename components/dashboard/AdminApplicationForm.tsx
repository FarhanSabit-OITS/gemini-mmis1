...
import { CITIES_AND_MARKETS } from '../../constants.ts';
        ...
        <Card title="Administrative Credentials">
          <div className="space-y-4">
             <div className="flex flex-col gap-1">
              ...
              <select 
                disabled
                className="bg-black text-white border-2 border-slate-800 rounded-xl px-4 py-3 text-sm outline-none w-full font-bold shadow-xl appearance-none"
              >
